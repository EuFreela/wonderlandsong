...
import { artificialHeritageTracks } from './blm-chapter5-lyrics';
...
import { aevumTracks } from './aevum-lyrics';
...
export const bunnyLandAlbums: ProjectAlbum[] = [
  ...
  {
    slug: 'chapter-5-artificial-heritage',
    ...
    warning:
      'Este capítulo ecoa a dor da perda e os dilemas éticos intensos do livro. Ouça com moderação.',
    duration: '58 min',
    trackCount: artificialHeritageTracks.length,
  ...
  historySections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'O projeto não se prende a um único tema. Qualquer assunto pode virar matéria de introspecção e metafísica — existência, tempo, identidade, consciência, moral, desejo, morte, o sagrado ou o cotidiano. O que permanece constante é o método: olhar de frente, questionar e transformar a reflexão em música.',
      ],
    },
    {
      id: 'name',
...
export const aevumAlbums: ProjectAlbum[] = [
  {
    ...
    description: [
      'Levels of Consciousness é o primeiro álbum do AEVUM. O trabalho explora questões filosóficas e espirituais sobre a existência, a consciência, o conhecimento e a busca humana por compreender Deus e o sentido do todo.',
      'As faixas nasceram de leituras, introspecção e conversas com pessoas reais, a partir do confronto entre diferentes filosofias e sua comparação com a Bíblia Sagrada. São questões que ultrapassam fronteiras religiosas: mesmo quem possui fé pode se deparar com dúvidas profundas sobre a existência, o Criador, a verdade e o próprio sentido da vida.',
      'Ao longo do álbum, o eu lírico atravessa diferentes estágios dessa investigação. Cada música representa um momento desse percurso: uma pergunta, uma tentativa de resposta, o confronto com aquilo que foi encontrado, o silêncio que permanece e, então, uma nova pergunta. Os níveis de consciência não representam uma doutrina ou uma sequência de respostas prontas, mas as mudanças de perspectiva de alguém que continua examinando aquilo em que acredita.',
      'O eixo do álbum é a busca pelo conhecimento de Deus e pela compreensão do todo. Nesse contexto, o conhecimento aparece como uma forma de fome espiritual: não apenas o desejo de acumular informações, mas a necessidade de compreender aquilo que está por trás da existência.',
      'Levels of Consciousness também é uma autorreflexão do compositor sobre experiências que fizeram parte de sua própria busca pelo Criador. Hoje, essa busca já encontrou sua resposta; as músicas revisitam caminhos que um dia foram percorridos, preservando as dúvidas, descobertas e confrontos daquele período. Por isso, o álbum não apresenta essas experiências como um caminho que o ouvinte precise reproduzir, mas como o registro de uma jornada que pertence à história do compositor. Se a resposta já fosse conhecida naquele momento, esses caminhos provavelmente nunca teriam sido percorridos.',
      'Musicalmente, o álbum se desenvolve dentro do Progressive Metal, com uma sonoridade densa, rítmica e atmosférica. Construções graduais, baixo em destaque, mudanças de dinâmica e o contraste entre peso e contemplação acompanham a própria ideia de progressão da consciência.',
    ],
    featuredVideo: {
    ...
    easterEgg: {
      ...
      subtitle: 'Levels of Consciousness · AEVUM',
      intro:
        'Cada faixa revela um sistema de conhecimento que o autor atravessou em busca do Criador — e o que essa travessia não conseguiu fechar.',
      note: 'Easter egg do álbum — o fio simbólico por trás das faixas.',
    },
    clips: [
      {
